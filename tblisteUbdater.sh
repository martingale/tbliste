...
#        #convertxls2csv -x tbliste.xls -b WINDOWS-1254 -c tbliste.txt -n 1 -a UTF-8
        ./xls2csv.py /home/c2/bondProject/tbliste/tbliste.xls /home/c2/bondProject/tbliste/tbliste.csv
...
# End of remove the exceptional ##
	...
	cut -d ";" -f 1-30 < tbliste_WIN1254.csv > foo.csv &&  mv foo.csv tbliste_WIN1254.csv # remove the columns after 30th column (@ 2017-03-01)
	git add . --all
